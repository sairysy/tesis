...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  $input = $_POST;		
  $sql = "INSERT INTO usuarios ( dni, nombres, apellidos, direccion, telefono, correo) VALUES (:dni, :nombres, :apellidos, :direccion, :telefono, :correo)";		  
...
$id = $_GET['id'];
$resultado = $conexion->prepare("DELETE FROM usuarios where id=:id");
